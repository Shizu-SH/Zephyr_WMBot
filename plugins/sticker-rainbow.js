...
const handler = async (m, {conn, args, usedPrefix, command}) => {
    ...
    const json = await conn.getFile(`https://api.fgmods.xyz/api/maker/rainbow?url=${link}&apikey=shizu`);
    console.log(`https://api.fgmods.xyz/api/maker/rainbow?url=${link}&apikey=shizu`)
